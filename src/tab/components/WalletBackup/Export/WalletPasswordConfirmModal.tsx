/**
 * WalletPasswordConfirmModal - Re-authenticate before export
 *
 * Step 2 in export flow. Requires user to confirm wallet password
 * before allowing backup export.
 */

import React, { useState } from 'react';
import Modal from '../../shared/Modal';

interface WalletPasswordConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (password: string) => Promise<void>;
}

export const WalletPasswordConfirmModal: React.FC<WalletPasswordConfirmModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
}) => {
    ...
    <Modal isOpen={isOpen} onClose={handleClose} className="max-w-lg">
      <form onSubmit={handleSubmit} className="p-6">
        ...
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-xl font-bold text-white">Confirm Your Wallet Password</h2>
        </div>

        {/* Instructions */}
        <p className="text-sm text-gray-300 mb-6">
          For security, please enter your wallet password to authorize this backup export.
        </p>
        ...
        {/* Error Message */}
        {error && (
          <div id="password-error" role="alert" className="mb-4 p-3 bg-red-500/15 border border-red-500/30 rounded-lg">
...
export default WalletPasswordConfirmModal;
